// <copyright file="RecommendedItemTouch.cs" company="Erik Bierbrauer">
...
namespace Apollo
{
    ...
    /// </summary>
    internal class RecommendedItemTouch
    {
        /// <summary>
        ...
        public class ItemTouchCallback : ItemTouchHelper.Callback
        {
            ...
            {
                // Only allow swiping to dismiss if the calling content item has a source of "historical"
                bool allowSwipe;

                try
                {
                    var recommendedViewHolder = (RecommendedFragment.RecommendedViewHolder)viewHolder;
                    var source = recommendedViewHolder.RecommendedContentItem.Data["source"];
                    allowSwipe = source == "historical";
                }
                catch
                {
                    allowSwipe = false;
                ...
                var swipeFlags = EnableTouch && allowSwipe ? ItemTouchHelper.Start | ItemTouchHelper.End : 0;
            ...
            public override void OnChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, bool isCurrentlyActive)
            {
                ...
                {
                    var alpha = 1.0f - (Math.Abs(dX) / viewHolder.ItemView.Width);
